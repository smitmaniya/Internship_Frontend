...
export default function StatBox() {
    return (
        <div className="stats-container">
            ...
            <div className="stats-box">
                <div className="stats-header">
                    <span className="stats-title">Total Pending</span>
                    <div className="image-container">
                    <img src={D4} alt="Total Order Icon" className="stats-icon"/>
                    </div>
                </div>
                <div className="stats-value">2040</div>
                <br/>
                <div className="stats-change positive">1.8% Up from yesterday</div>
            </div>
        </div>
    );
}
